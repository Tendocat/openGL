...
// UNIFORM
vec4 COLOR_MAP [255] = vec4[255](
	vec4(0.0,        0.6372549,  0.88823529, 1.0),
...
void main()
{
	...
	// AMBIANT
	vec3 Ka = COLOR_MAP[clamp(int(height*200.),0,254)].xyz;	// adapt to colormap length
...
function init_wgl()
{
	...
	UserInterface.begin("I",true,true);
		// TERRAIN
		...
		slider_terrainSize = UserInterface.add_slider('Size', 1, 30, 5, buildTerrainMesh);
